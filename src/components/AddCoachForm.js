...
const AddCoachForm = ({ isOpen, onSubmit }) => {
  ...
  return (
    ...
    >
        <HomeNavbar/>
      <div className="max-w-screen-full pt-16 md:p-16 p-5"></div>
        <div className=" flex relative w-full items-center justify-center p-2 ">
        <div className="w-[5%] ">
         <Navbar/>
        </div>
            <div className=" h-full bg-gray-100 lg:w-[95%] w-[100%] lg:mx-3 lg:px-10 p-5 lg:rounded-tl-[3rem] rounded-lg shadow-lg"
            style={{
