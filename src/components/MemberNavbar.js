          ...
          <li>
            ...
            {activeDropdown === 'overview' && (
              <ul className="space-y-2 mt-2 text-white text-left">
                <li><button onClick={() => handleDropdownClick('/coach')} className="block px-4 py-2 hover:bg-yellow-500">Coaches</button></li>
                <li><button onClick={() => handleDropdownClick('/allplayers')} className="block px-4 py-2 hover:bg-yellow-500">All Players</button></li>
                <li><button onClick={() => handleDropdownClick('/oldboys')} className="block px-4 py-2 hover:bg-yellow-500">Old Boys</button></li>
                <li><button onClick={() => handleDropdownClick('/about-us')} className="block px-4 py-2 hover:bg-yellow-500">About Us</button></li>
              </ul>
            )}
          </li>
          <li>
            ...
            {activeDropdown === 'teams' && (
              <ul className="space-y-2 mt-2 text-white text-left">
                <li><button onClick={() => handleDropdownClick('/under13')} className="block px-4 py-2 hover:bg-yellow-500">Under 13</button></li>
                <li><button onClick={() => handleDropdownClick('/under15')} className="block px-4 py-2 hover:bg-yellow-500">Under 15</button></li>
                <li><button onClick={() => handleDropdownClick('/under17')} className="block px-4 py-2 hover:bg-yellow-500">Under 17</button></li>
                <li><button onClick={() => handleDropdownClick('/under19')} className="block px-4 py-2 hover:bg-yellow-500">Under 19</button></li>
              </ul>
            )}
          </li>
          <li>
            ...
            {activeDropdown === 'academy' && (
              <ul className="space-y-2 mt-2 text-white text-left">
                <li><button onClick={() => handleDropdownClick('/academy9')} className="block px-4 py-2 hover:bg-yellow-500">Academy 9</button></li>
                <li><button onClick={() => handleDropdownClick('/academy11')} className="block px-4 py-2 hover:bg-yellow-500">Academy 11</button></li>
                <li><button onClick={() => handleDropdownClick('/academy13')} className="block px-4 py-2 hover:bg-yellow-500">Academy 13</button></li>
                <li><button onClick={() => handleDropdownClick('/academy15')} className="block px-4 py-2 hover:bg-yellow-500">Academy 15</button></li>
                <li><button onClick={() => handleDropdownClick('/academy17')} className="block px-4 py-2 hover:bg-yellow-500">Academy 17</button></li>
              </ul>
            )}
          </li>
          <li>
            ...
            {activeDropdown === 'legends' && (
              <ul className="space-y-2 mt-2 text-white text-left">
                <li><button onClick={() => handleDropdownClick('/over40')} className="block px-4 py-2 hover:bg-yellow-500">Over 40s</button></li>
                <li><button onClick={() => handleDropdownClick('/over50')} className="block px-4 py-2 hover:bg-yellow-500">Over 50s</button></li>
