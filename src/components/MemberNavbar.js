...
const HomeNavbar = () => {
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between w-fit bg-transparent backdrop-blur-md shadow-lg px-6 py-2 rounded-lg">
        {/* Logo on the left */}
        <div className="flex items-center">
          <Link to="/member">
            <img src={Logo} alt="Logo" className="h-10 w-10 mr-4" /> {/* Add logo with appropriate height/width */}
        ...
        <ul className="flex space-x-8 text-white font-semibold text-14px">
          ...
          <li className="relative group">
            ...
            <ul className="absolute left-0 top-full mt-2 bg-gray-800 shadow-lg w-40 opacity-0 invisible group-hover:visible group-hover:opacity-100 transition-all duration-300 ease-in-out rounded-lg">
              <li>
                <button
                  className="block w-full text-left px-4 py-2 hover:bg-yellow-500 hover:text-black transition-all duration-300 ease-in-out rounded-lg"
                  onClick={() => handleDropdownClick('/coach')}
                >
                  Coaches
                </button>
        ...
        <div className="relative group ml-8">
          ...
          {/* Dropdown for User */}
          <ul className="absolute left-0 top-full mt-2 bg-gray-800 text-white shadow-lg w-40 opacity-0 invisible group-hover:visible group-hover:opacity-100 transition-all duration-300 ease-in-out rounded-lg">
            <li>
              <button
                className="block w-full text-left px-4 py-2 hover:bg-yellow-500 transition-all duration-300 ease-in-out rounded-lg"
