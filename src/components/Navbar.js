...
const Navbar = () => {
  ...
  return (
    <>
      <div
        className={`flex h-full w-full flex-col justify-center items-center border border-[#00175F]`}
      >
        <div className="w-full py-2 px-2 border-b border-[#00175F] flex items-center">
          <h1 className="h-20 py-5 pl-4 relative text-white text-2xl font-bold">
            RCC Admin
          </h1>
        </div>
        <ul className="flex flex-col w-full h-full">
          <Link
            onClick={() => setActiveLink("/member")}
            to={"/member"}
            className={`${getLinkClass(
              "/member"
            )} group flex flex-wrap gap-3 pl-4 py-4 items-center text-2xl text-center p-2 text-white w-full hover:bg-gray-300 hover:bg-opacity-20`}
          >
            {" "}
          ...
          <Link
            ...
            className={`${getLinkClass(
              "/team"
            )} group flex flex-wrap pl-4 gap-3 py-4 text-2xl cursor-pointer items-center p-2  text-white w-full hover:bg-gray-300 hover:bg-opacity-20`}
          >
            {" "}
          ...
          <Link
            ...
            className={`${getLinkClass(
              "/match"
            )} group flex flex-wrap gap-3 py-4 pl-4 cursor-pointer text-2xl items-center p-2  text-white w-full hover:bg-gray-300 hover:bg-opacity-20`}
          >
            {" "}
            <BiSolidCricketBall className="text-white" />{" "}
            <span className="text-sm text-white transition-opacity duration-300 mt-1">
              Matches
            </span>
          </Link>
          ...
          >
            {" "}
            <TbScoreboard className="text-white" />{" "}
            <span className="text-sm text-white transition-opacity duration-300 mt-1">
              Score
            </span>
          </Link>
