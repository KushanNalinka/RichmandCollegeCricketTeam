        ...
        <>
            ...
            >
                <ul className="flex flex-col w-full items-center justify-center mt-5 pl-1">
                    ...
                    <Link to={"/coachInfo"} className=" gap-3 flex flex-col group cursor-pointer pl-2 py-4 text-2xl items-center justify-center p-2  text-white w-full">
                        {" "}<BsPersonFill /> <span className="text-sm text-white opacity-0 group-hover:opacity-100 transition-opacity duration-300 mt-1">Coaches</span>
                    </Link>
                </ul>
            </div>
        </>
