...
// import React, { useState, useEffect } from "react";
// import { FaTimes, FaCamera, FaEdit, FaTrash } from "react-icons/fa";
// import axios from "axios";
// import { message, Spin } from "antd";
...
//     username: "",
//     password: "",
//     membership: { isMemberHolder: 1, startDate: "", endDate: "" },
//     contactNo: ""
//   });
//   const [errors, setErrors] = useState({});
//   const [uploading, setUploading] = useState(false);
...
//       const playerData = { ...formData, image: imageURL };
//       const response = await axios.post(`${API_URL}auth/signupPlayer`, playerData);
...
//   const handleEditImageClick = () => setIsEditImage(true);
//   const handleRemoveImage = () => {
//     setImagePreview(null);
//     setIsImageAdded(false);
//     setIsEditImage(false);
...
//   return (
//     <div className="fixed inset-0 flex items-center justify-center bg-gray-600 bg-opacity-75">
//       <div className={`bg-white ${uploading ? "opacity-80" : "opacity-100"} p-8 rounded-lg shadow-lg max-w-xl w-full relative`}>
//         <div className="flex justify-end">
//           <button onClick={onClose} className="text-xl text-gray-600 hover:text-gray-800">
//             <FaTimes />
//           </button>
//         </div>
//         <h2 className="text-xl text-[#480D35] font-bold mb-4">Add Player Details</h2>
