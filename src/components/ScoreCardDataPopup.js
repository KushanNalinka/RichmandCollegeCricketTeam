...
const ScorecardDataPopup = ({ onClose, data }) => {
  ...
  return (
    <div className="fixed inset-0 flex min-h-screen flex-col -top-5 bg-gray-100 z-50 overflow-auto">
      ...
      <div className="relative">
        ...
        >
          <button
            className="flex items-center space-x-2 text-white bg-[#012D5E] hover:bg-[#05386B]  px-3 py-2 rounded-full shadow-lg"
            onClick={onClose} // Navigate to the previous page
          >
            <svg
...
export default ScorecardDataPopup;
