...
const groupPlayersByAge = (players) => {
  const grouped = {
    "Under 9": [],
    "Under 11": [],
    "Under 13": [],
  ...
  players.forEach((player) => {
    ...
    if (age <= 9) grouped["Under 9"].push(player);
    else if (age <= 11) grouped["Under 11"].push(player);
    else if (age <= 13) grouped["Under 13"].push(player);
    else if (age <= 15) grouped["Under 15"].push(player);
    else if (age <= 17) grouped["Under 17"].push(player);
    else if (age <= 19) grouped["Under 19"].push(player);
    else if (age > 50) grouped["Over 50"].push(player);
    else if (age > 40) grouped["Over 40"].push(player);
    else grouped["Old Boys"].push(player);
  });
...
const groupedPlayers = groupPlayersByAge(players);
