    ...
    useEffect(() => {
      const timeout = setTimeout(() => {
        if (searchingPlayer) {
          ...
          setFilteredPlayers(players); // Show all players if search query is empty
        }
      }, 300); // 300ms debounce delay
  
      return () => clearTimeout(timeout); // Cleanup timeout
    }, [searchingPlayer, players]);
...
<div className="md:hidden top-20 left-0 right-0 bg-gray-200 p-4 rounded-lg shadow-md z-10"> {/* Use md:hidden to hide on larger screens */}
    ...
    <div className="relative">
                                <input
                                   ...
                                   className="w-full px-2 py-1 border border-gray-300 rounded-xl text-xs shadow-sm focus:outline-none focus:ring-2 cursor-pointer focus-within:ring-0 focus-within:ring-transparent focus-within:outline-none text-gray-600"
                ...
                <div className="flex gap-6 justify-center px-10 md:flex-row flex-col">
                    ...
                    <div className="md:flex hidden bg-gray-200 rounded-lg shadow-md" style={{ width: '350px', flexShrink: 0, maxHeight: '469px', flexDirection: 'column' }}>
                        ...
                        <div className="p-4 border-b text-black border-gray-100">
                            ...
                            <div className=" hidden md:flex text-gray-600 border bg-white border-gray-300 px-3 rounded-3xl focus-within:ring-1 focus-within:ring-[#00175f] focus-within:outline-none mt-3">
                                <input
                                    type="text"
                                    onChange={(e) => setSearchingPlayer(e.target.value)}
                                    ...
                                    <button
                                        type="button"
                                        className="flex items-center w-[10%] justify-center text-gray-500 hover:text-gray-700 rounded-md focus-within:outline-none "
                                        //onClick={handleSearchChange}
                                        >
                                        <IoIosSearch />
                                    </button>
