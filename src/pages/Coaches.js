        ...
        <div className="bg-gray-300 min-h-screen text-white">
            ...
            <div className="max-w-screen-lg pt-24 mx-auto">
                ...
                <div className="flex flex-col md:flex-row gap-6">
                    ...
                    <div
                        className="hidden md:block bg-gray-800 rounded-lg shadow-md"
                        style={{
                            width: "350px",
                            flexShrink: 0,
                            marginTop: "0px",
                        ...
                        <div className="p-4 overflow-y-auto" style={{ flexGrow: 1, maxHeight: "calc(500px - 64px)" }}>
                            <ul className="space-y-3">
                                {coachesData.map((coach) => (
                                    <li
                                        key={coach.coachId}
                                        className={`cursor-pointer p-3 rounded-lg ${coach.coachId === selectedCoach.coachId ? 'bg-gray-700 font-bold' : 'bg-gray-800'}`}
                                        onClick={() => setSelectedCoach(coach)}
                                    >
                    ...
                    <div className="flex-grow bg-gray-800 p-6 rounded-lg shadow-md" style={{ minHeight: '500px' }}>
                        ...
                        <div className="mt-6 bg-gray-900 p-6 rounded-lg shadow-md">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                                <div>
                                    <p><span className="font-semibold text-gray-400">Contact:</span> {selectedCoach.contactNo}</p>
                                    <p><span className="font-semibold text-gray-400">Email:</span> {selectedCoach.email}</p>
                                    <p><span className="font-semibold text-gray-400">Address:</span> {selectedCoach.address}</p>
                                </div>
                                <div>
                                    <p className="font-semibold text-gray-400">Description:</p>
                                    <p>{selectedCoach.description}</p>
