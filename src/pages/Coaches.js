                        ...
                        >
                            <ul className="space-y-3" style={{ paddingRight: '10px' }}>
                                {coachesData.map((coach) => (
                                    <li
                                        key={coach.id}
                                        className={`cursor-pointer flex items-center p-3 rounded-lg transition duration-300 ease-in-out hover:bg-gray-700 ${coach.id === selectedCoach.id ? 'bg-gray-700 font-bold' : 'bg-gray-800'}`}
                    ...
                    <div className="flex-grow bg-cover bg-center bg-no-repeat p-6 rounded-lg shadow-md bg-gray-800" >
                        <div className="flex items-center space-x-6 bg-white bg-opacity-75 p-6 rounded-lg"
                            ...
                            <div className="flex-grow">
                                ...
                                <p className="text-white">{selectedCoach.age} years old</p>
                            </div>
                        </div>
...
<table className="min-w-full mt-4 bg-gray-900 rounded-lg shadow-md w-full">
    <thead>
        <tr>
            <th className="py-2 px-16 text-center text-gray-700 font-semibold align-middle whitespace-nowrap">Venue</th>
            <th className="py-2 px-16 text-center text-gray-700 font-semibold align-middle whitespace-nowrap">Start Time</th>
            <th className="py-2 px-16text-center text-gray-700 font-semibold align-middle whitespace-nowrap">End Time</th>
            <th className="py-2 px-16 text-center text-gray-700 font-semibold align-middle whitespace-nowrap">Type</th>
            <th className="py-2 px-16 text-center text-gray-700 font-semibold align-middle whitespace-nowrap">Actions</th>
        </tr>
    </thead>
    <tbody>
        {practiceSchedulesData.map((schedule) => (
            <tr key={schedule.id}>
                <td className="py-2 px-4 border-b border-gray-200 text-center align-middle whitespace-nowrap">{schedule.venue}</td>
                <td className="py-2 px-4 border-b border-gray-200 text-center align-middle whitespace-nowrap">{schedule.startTime}</td>
                <td className="py-2 px-4 border-b border-gray-200 text-center align-middle whitespace-nowrap">{schedule.endTime}</td>
                <td className="py-2 px-4 border-b border-gray-200 text-center align-middle whitespace-nowrap">{schedule.type}</td>
