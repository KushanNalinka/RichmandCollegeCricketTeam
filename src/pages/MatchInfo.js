  ...
  <div className="w-full flex flex-col items-center space-y-4">
    <div className="flex justify-between w-full space-x-4">
      ...
      <div className="text-center flex-1">
        ...
        />
        <h3 className="text-xs font-bold">RICHMOND COLLEGE</h3>
        {matchData.innings && matchData.innings.map((inning, idx) => (
  <div key={idx} className="mt-2">
    <p className="text-sm">{inning.runs}/{inning.wickets}</p>
    <p className="text-xxs">{inning.overs}</p>
  </div>
))}
      ...
      <div className="flex flex-col items-center justify-center">
       ...
       <div className="text-center flex-1">
        <img
          ...
          className="w-10 h-10 rounded-full mx-auto"
        />
        <h3 className="text-xs font-bold">{matchData.opposition.toUpperCase()}</h3>
        {matchData.innings.map((inning, idx) => (
          <div key={idx} className="mt-2">
            <p className="text-sm">{inning.oppositionRuns}/{inning.oppositionWickets}</p>
