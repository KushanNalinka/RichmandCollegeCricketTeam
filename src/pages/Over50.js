...
//                         (team) => team.under === "Richmond Legend Over 50" && parseInt(team.year, 10) === selectedYear
//                     )
//                 );
...
//                 Richmond Legend Over 50s Year {selectedYear}
//                                 </p>
//             </div>
//                {/* Year Dropdown */}
...
//             <h1 className="text-2xl">No players for Richmond Legends over 50s {selectedYear}</h1>
//         </div>
//     ) : null}
// </p>
//                             <ul className="space-y-3 text-black" style={{ paddingRight: '10px' }}>
    ...
    return (
        <div className="bg-gray-400 min-h-screen text-white">
            ...
            <div className="max-w-screen pt-20">
                {/* Mobile Player List Toggle - comes before Header Section */}
                {/* Mobile Player List Toggle - only visible on mobile screens */}
    <div className="md:hidden top-20 left-0 right-0 bg-gray-200 px-5 py-2 rounded-lg shadow-md z-10"> {/* Use md:hidden to hide on larger screens */}
    <button 
        onClick={() => setShowPlayerList(!showPlayerList)} 
        className="text-black font-bold flex justify-between items-center w-full"
    >
