...
const SponsoredBy = () => {
  const committeeMembers = [
    ...
    { id: 9, name: 'P. A. Gunawardane', role: 'Committee Member', image: '/path/to/p_a_gunawardane.png' },
    { id: 10, name: 'Nishantha Mendis', role: 'Committee Member', image: '/path/to/nishantha_mendis.png' },
    { id: 11, name: 'C. K. Hewamanna', role: 'Committee Member', image: '/path/to/c_k_hewamanna.png' },
    { id: 12, name: 'Thushan Jayawardane', role: 'Committee Member', image: '/path/to/thushan_jayawardane.png' },
    { id: 13, name: 'Upul Yatawara', role: 'Committee Member', image: '/path/to/upul_yatawara.png' },
    { id: 14, name: 'Asitha De Silva', role: 'Committee Member', image: '/path/to/asitha_de_silva.png' },
    { id: 15, name: 'Mihiruk De Silva', role: 'Committee Member', image: '/path/to/mihiruk_de_silva.png' },
    { id: 16, name: 'Banuka Rathnayake', role: 'Committee Member', image: '/path/to/banuka_rathnayake.png' },
    { id: 17, name: 'Chathupama Gunasinghe', role: 'Committee Member', image: '/path/to/chathupama_gunasinghe.png' },
    { id: 18, name: 'Sanjaya De Silva', role: 'Committee Member', image: '/path/to/sanjaya_de_silva.png' },
    { id: 19, name: 'Chamath Siriwardana', role: 'Committee Member', image: '/path/to/chamath_siriwardana.png' },
    { id: 20, name: 'Tharindu Weerasinghe', role: 'Committee Member', image: '/path/to/tharindu_weerasinghe.png' },
  ];
